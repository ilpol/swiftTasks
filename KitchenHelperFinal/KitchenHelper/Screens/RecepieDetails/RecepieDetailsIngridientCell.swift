...
class RecepieDetailsIngridientCell: UICollectionViewCell {
    ...
    func setContent(name: String) {
        ...
        let imgUrl = "https://www.themealdb.com/images/ingredients/\(name.replacingOccurrences(of: " ", with: "%20")).png"
        recepieImage.downloadFrom(from: imgUrl)
    }
    ...
    override func layoutSubviews() {
        ...
        recepieImage.frame = CGRect(x: 35,
                                    y: 10,
                                    width: 90,
                                    height: 80
            )
