...
protocol AnyRouterFridgeItem {
    static func start(from: UIViewController, fridgeItem: FridgeItem) -> AnyRouterFridgeItem
...
class FridgeItemRouter: AnyRouterFridgeItem {
    ...
    static func start(from prevView: UIViewController, fridgeItem: FridgeItem)-> AnyRouterFridgeItem {
